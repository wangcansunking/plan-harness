...
// Use gh CLI — it's available on GitHub-hosted runners.
const prBody = [
...
sh(
  `gh pr create --repo ${MARKETPLACE_REPO} --base main --head ${branch} --title "chore: bump ${PLUGIN_NAME} to ${NEW_VERSION}" --body ${JSON.stringify(prBody)}`,
);
